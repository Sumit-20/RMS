		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
				<div class="p-4 pt-5">
		  		...
		  		<div class="container text-center" class="caption"><c:out value="${fa.faUserName}"></c:out></div>
<%-- 		  		<div class="container text-center" class="caption"><c:out value="${company.email}"></c:out></div> --%>
		  		<br></br>
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li class="nav-item">
	          <a class="nav-link" href="/view">Evaluate Applications</a>
	          </li>
	          <li class="nav-item">
	          <a class="nav-link" href="/addfa">Add new Financial Analyst</a>
	          </li>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <h2 class="mb-4">Welcome <c:out value="${fa.faUserName}"></c:out></h2>
       <!-- change start -->
       <div>
        <table class="table table-borderless">
          <tr>
            <td>Name :</td>
            <td><c:out value="${fa.name}"></c:out></td>
          </tr>
          <tr>
            <td>Email Id :</td>
            <td><c:out value="${fa.email}"></c:out></td>		
          </tr>
          <tr>
            <td>User Name :</td>
            <td><c:out value="${fa.faUserName}"></c:out></td>		
          </tr>	  
        </table>
      </div>
      <br>
      <p>You can evaluate all the applications through Evalaute Application tab,view history of all the previous approved and rejected applications through application history tab and add a new Financial Analyst when needed through the Add New Financial Analyst tab.</p>
       <!-- change end -->
      </div>
		</div>
		</section>
...
of policies which get triggered on every submitted application to decide whether to approve or decline, and get a quick status of your applied application either approved or reject with in your profile.</p>
